...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<a href="checkout.jsp"><i class="fas fa-cart-plus fa-2x mt-1"></i></a>
		
			<a href="login.jsp" class="btn btn-success"><i class="fas fa-user-plus"></i> ${userobj.name}</a> <a href="logout"
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<a href="" class="btn btn-light my-2 my-sm-0 ml-1" type="submit"><i class="fas fa-phone-square-alt"></i> Contact Us</a>
		</form>
	</div>
</nav>
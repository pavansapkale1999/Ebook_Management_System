							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Name</label> <input type="text"
										class="form-control" id="inputEmail4" name="username" <%-- value="${userobj.name }" --%> required="required">
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">Email</label> <input type="email"
										class="form-control" id="inputPassword4" name="email" <%-- value="${userobj.email }" --%> required="required">
								</div>

								<div class="form-group col-md-6">
									<label for="inputEmail4">Phone No</label> <input type="number"
										class="form-control" id="inputEmail4" name="phoneno" <%-- value="${userobj.phoneno }" --%> required="required">
								</div>
								<div class="form-group col-md-6">
